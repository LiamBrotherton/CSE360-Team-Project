...
public class ViewDeleteUser {
	...
	*/
	...
	public ViewDeleteUser() {
		...
		setupButtonUI(button_DeleteUser, "Dialog", 16, 250, Pos.CENTER, 20, 190);
		...
		// The formatting of the page does not change dynamically so more code has been added. 
