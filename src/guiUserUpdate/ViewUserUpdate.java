	...
	private ViewUserUpdate() {
        ...
        button_UpdateFirstName.setOnAction((_) -> {result = dialogUpdateFirstName.showAndWait();
            result.ifPresent(value -> {
                if (ControllerUserUpdate.isValidName(value, "First Name")) {
        ...
        button_UpdateMiddleName.setOnAction((_) -> {result = dialogUpdateMiddleName.showAndWait();
        	result.ifPresent(value -> {
        		if (ControllerUserUpdate.isValidName(value, "Middle Name")) {
        ...
        button_UpdateLastName.setOnAction((_) -> {result = dialogUpdateLastName.showAndWait();
        	result.ifPresent(value -> {
        		if (ControllerUserUpdate.isValidName(value, "Last Name")) {
        ...
        button_UpdatePreferredFirstName.setOnAction((_) -> {result = dialogUpdatePreferredFirstName.showAndWait();
        	result.ifPresent(value -> {
        		if (ControllerUserUpdate.isValidName(value, "Preferred First Name")) {
