...
public class ControllerOnetimePassword {
	...
	protected static void repaintTheWindow() {
		...
		if (ViewOnetimePassword.theSelectedUser.compareTo("<Select a User>") == 0) {
			...
			ViewOnetimePassword.theRootPane.getChildren().addAll(
					...
					ViewOnetimePassword.label_SetaOnetimePassword,
					ViewOnetimePassword.text_Password,
					ViewOnetimePassword.button_SetPassword,
		...
		ViewOnetimePassword.theStage.setTitle("CSE 360 Foundation Code: Admin Operations Page");
	 ...
	 * 
	 * <p> Description: This method sets a onetime password for a selected user
	 * list. </p>
	 * 
	 */
